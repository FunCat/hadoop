...
public class IpBytesMapperTest {
    ...
    public void testCase1() throws IOException {
        ...
        mapDriver.withOutput(new Text("ip1"), new IpWritable(new Text("ip1"), new FloatWritable(0), new LongWritable(40028)));
        mapDriver.runTest();
    }
    ...
    public void testCase2() throws IOException {
        ...
        mapDriver.withOutput(new Text("ip2"), new IpWritable(new Text("ip2"), new FloatWritable(0), new LongWritable(390)));
        mapDriver.runTest();
    }
    ...
    public void testCase3() throws IOException {
        ...
        mapDriver.withOutput(new Text("ip6"), new IpWritable(new Text("ip6"), new FloatWritable(0), new LongWritable(12550)));
        mapDriver.runTest();
    }
